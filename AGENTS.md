...
- Full suite: `python -m pytest -q` (~143 tests, ~1 min, no external services).
...
- Security self-check: `python -m sentrylink.redteam` (16 checks, must all print `[PASS]`).
